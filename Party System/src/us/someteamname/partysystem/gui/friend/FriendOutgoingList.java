...
public class FriendOutgoingList extends MenuPaginated {
  public FriendOutgoingList(Manager manager) {
    super(manager);
  }
  ...
  public void handleMenu(InventoryClickEvent e) {
    ...
    ArrayList<String> requests = new ArrayList<>(this.api.getSentRequests(p));
    ...
    if (mat.equals(Material.END_CRYSTAL)) {
      ...
      (new FriendOutgoing(manager)).open();
  ...
  public void setMenuItems() {
    ...
    addMenuBorder();
    ArrayList<String> requests = new ArrayList<>(this.api.getSentRequests(this.manager.getPlayerFetch()));
